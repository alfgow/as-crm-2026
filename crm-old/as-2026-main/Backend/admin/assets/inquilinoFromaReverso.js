function handleFormaReversoSelect(input) {
	...
	const preview = document.getElementById("forma-reverso-preview");
	const actions = document.getElementById("forma-reverso-actions");
	...
	btnConfirm.onclick = () => {
		...
		fetch(
			...
			.then((j) => {
				...
				Swal.fire({
					icon: "success",
					title: "¡Forma Migratoria Reverso subida!",
					timer: 1500,
