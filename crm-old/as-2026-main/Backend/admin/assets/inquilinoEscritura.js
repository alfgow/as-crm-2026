// inquilinoEscritura.js
function handleEscrituraSelect(input) {
	...
	const preview = document.getElementById("escritura-preview");
	const actions = document.getElementById("escritura-actions");
