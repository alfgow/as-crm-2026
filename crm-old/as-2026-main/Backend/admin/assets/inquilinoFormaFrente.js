function handleFormaFrontalSelect(input) {
	...
	const preview = document.getElementById("forma-frontal-preview");
	const actions = document.getElementById("forma-frontal-actions");
	...
	btnConfirm.onclick = () => {
		...
		fetch(
			...
			.then((j) => {
				...
				Swal.fire({
					icon: "success",
					title: "¡Forma Migratoria Frente subida!",
					timer: 1500,
