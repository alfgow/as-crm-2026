// inquilinoPasaporte.js
function handlePasaporteSelect(input) {
	...
	const preview = document.getElementById("pasaporte-preview");
	const actions = document.getElementById("pasaporte-actions");
