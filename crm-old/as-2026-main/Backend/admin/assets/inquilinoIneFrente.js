// inquilinoIneFrente.js
function handleIneFrontalSelect(input) {
	...
	const preview = document.getElementById("ine-frente-preview");
	const actions = document.getElementById("ine-frente-actions");
	if (!preview || !actions) return;

	preview.innerHTML = "";
	actions.innerHTML = "";

	// Mostrar preview (sólo imágenes permitidas aquí)
